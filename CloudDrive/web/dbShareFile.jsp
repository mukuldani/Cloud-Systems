     ...
     String connectionUrl = "jdbc:sqlserver://localhost:1433;" +
		...
		Connection con = null;
        	...
        	try {
                ...
                String userid="USR2";
                String recid=request.getParameter("txtUser");
                String fileid=request.getParameter("txtFile");
                
                String pass="";
                        Statement st=con.createStatement();
                        ResultSet rs=st.executeQuery("select password from Files where fileid='"+fileid+"'");
                        while(rs.next())
                        {
            ...
            for(int i=0;i<arr.length;i++)
            {
              ...
              for(int i=0;i<count;i++)
              {
                ...
                PreparedStatement ps=con.prepareStatement("insert into FileTrack(userid,recid,fileid,encrykey,pass,ontime,status) values('"+userid+"','"+recid+"','"+fileid+"','"+key+"','"+pass+"',getDate(),0)");
